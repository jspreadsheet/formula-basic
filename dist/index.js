(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@formulajs/formulajs"), require("jsuites"));
	else if(typeof define === 'function' && define.amd)
		define(["@formulajs/formulajs", "jsuites"], factory);
	else if(typeof exports === 'object')
		exports["FormulaBasic"] = factory(require("@formulajs/formulajs"), require("jsuites"));
	else
		root["FormulaBasic"] = factory(root["@formulajs/formulajs"], root["jsuites"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE__901__, __WEBPACK_EXTERNAL_MODULE__777__) {
...
if (!jSuites && "function" === 'function') {
    var jSuites = __webpack_require__(777);
}

if (!formulajs && "function" === 'function') {
    var formulajs = __webpack_require__(901);
}
                ...
                for (let a = 0; a < values.length; a++) {
                    if (typeof values[a] == 'object') {
                        ...
                        if (formulajs[method][subMethod]) {
                            keys = [...keys, ...Object.keys(formulajs[method][subMethod]).map((a) => subMethod + '.' + a)] // Line too heavy, need refactor
...
!function() {
"use strict";
let formula = __webpack_require__(960)
